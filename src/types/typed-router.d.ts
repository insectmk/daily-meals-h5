...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/plan/component/plan-recipe-card-list': RouteRecordInfo<'/plan/component/plan-recipe-card-list', '/plan/component/plan-recipe-card-list', Record<never, never>, Record<never, never>>,
    ...
    '/recipe-cache/tab-pages/RecipeSelf': RouteRecordInfo<'/recipe-cache/tab-pages/RecipeSelf', '/recipe-cache/tab-pages/RecipeSelf', Record<never, never>, Record<never, never>>,
    '/recipe-cache/tab-pages/RecipeSystem': RouteRecordInfo<'/recipe-cache/tab-pages/RecipeSystem', '/recipe-cache/tab-pages/RecipeSystem', Record<never, never>, Record<never, never>>,
